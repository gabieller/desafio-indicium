    ...
    <div className="header px-0 px-md-5">
      ...
      <nav className={`navbar fixed-top justify-content-start ${visibility}`}>
        <ul className="d-flex flex-inline px-0 px-md-3">
          <Link href="#home">
            <li className={`nav-item px-2 px-md-3  py-0 ${uri === "#home" ? "active" : ""}`}>
              <Image src="/images/home.svg" height={36} width={36} />
            </li>
          </Link>

          <Link href="#about">
            <li className={`nav-item px-2 px-md-3 py-0 ${uri === "#about" ? "active" : ""}`}>
              <Image src="/images/user.svg" height={36} width={36} />
            </li>
          </Link>
          <Link href="#experiences">
            <li
              className={`nav-item px-2 px-md-3 py-0 ${
          ...
          <Link href="#skills">
            <li
              className={`nav-item px-2 px-md-3 py-0 ${uri === "#skills" ? "active" : ""}`}
            >
